              ...
              >
                <div className="flex items-center gap-6 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-ink-500 italic truncate">
                      {s.reference}
                    </p>
                  </div>
                </div>
                <div className="hidden md:flex flex-col items-end gap-1 shrink-0">
                  ...
                  <span className="text-sm text-ink-500">{s.pastor}</span>
                </div>
                <svg
                  width="18"
                  height="18"
                  ...
                  stroke="currentColor"
                  strokeWidth="1.6"
                  className="text-sand-400 group-hover:text-ocean-700 transition-colors shrink-0"
                >
                  <path d="M5 12h14M13 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </a>
